...
Kirki::add_field('neuron_kirki', array(
	'type'        => 'typography',
	'settings'    => 'typography_hero_subtitle',
	'label'       => esc_attr__('Subtitle', 'neuron-core'),
	'section'     => 'typography_hero',
	'default'     => array(
		'font-size'      => '',
	...
	'output' => array(
		array(
			'element' => $neuron_attributes_selectors['hero-subtitle'],
		),
	),
));
