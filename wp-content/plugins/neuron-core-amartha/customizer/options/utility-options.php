...
Kirki::add_field('neuron_kirki', array(
    ...
    'description' => __('Select the type of hero. <br /><small>Note: Do not forget to add heroes in Elementor Templates.</small>', 'neuron-core'),
	'section'     => 'hero_section',
	'default'     => '1',
    'choices'     => array(
...
Kirki::add_field('neuron_kirki', array(
    ...
    'description' => __('Select the template.', 'neuron-core'),
	'section'     => 'hero_section',
    'choices'     => neuron_get_elementor_templates('hero'),
    'active_callback' => array(
        array(
            'setting'  => 'hero_type',
            'operator' => '==',
...
Kirki::add_field('neuron_kirki', array(
    ...
    'choices'     => array(
        ...
        '2' => esc_attr__('Custom Image', 'neuron-core'),
        '3' => esc_attr__('No Image', 'neuron-core')
    ),
    'active_callback' => array(
        array(
            'setting'  => 'hero_type',
...
Kirki::add_field('neuron_kirki', array(
	...
	'section'     => 'hero_section',
    'default'     => '<h1>' . esc_html__('Subtitle', 'neuron-core') . '</h1> <hr>',
    'active_callback' => array(
        array(
            'setting'  => 'hero_type',
            'operator' => '!=',
...
Kirki::add_field('neuron_kirki', array(
    ...
    'label'       => esc_html__('Subtitle', 'neuron-core'),
    'description' => __('Select if you want to inherit the subtitle or set it custom..', 'neuron-core'),
	'section'     => 'hero_section',
	'default'     => '2',
    'choices'     => array(
        '1' => esc_attr__('Breadcrumb', 'neuron-core'),
        '2' => esc_attr__('Custom', 'neuron-core')
    ),
    'active_callback' => array(
        array(
            'setting'  => 'hero_type',
...
Kirki::add_field('neuron_kirki', array(
    ...
    'label'       => esc_html__('Editor', 'neuron-core'),
    'description' => __('Enter the subtitle, it accepts html tags too.', 'neuron-core'),
    'section'     => 'hero_section',
    'active_callback' => array(
        array(
...
Kirki::add_field('neuron_kirki', array(
	...
	'settings'    => 'hero_subtitle_animation',
    'label'       => esc_html__('Animation', 'neuron-core'),
    'description' => __('Select initial loading animation for the subtitle.', 'neuron-core'),
	'section'     => 'hero_section',
	'default'     => '2',
    'choices'     => array(
        '1' => esc_attr__('None', 'neuron-core'),
...
Kirki::add_field('neuron_kirki', array(
	...
	'label'       => __('Color', 'neuron-core'),
	'description' => __('Change the text color of subtitle. <br /><small>Note: The default color is #858585.</small>', 'neuron-core'),
	'section'     => 'hero_section',
    'default'     => '#858585',
    'active_callback' => array(
        array(
