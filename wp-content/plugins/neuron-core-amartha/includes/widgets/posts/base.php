...
class NeuronPosts extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .l-posts-wrapper .o-neuron-hover--meta-inside .o-neuron-hover-holder .o-neuron-hover-holder__body-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .l-posts-wrapper .o-neuron-hover--meta-inside .o-neuron-hover-holder .o-neuron-hover-holder__body-meta' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => ['classic', 'gradient'],
				'separator' => 'before',
				'selector' => '{{WRAPPER}} .l-posts-wrapper .o-post .o-blog-post__content, {{WRAPPER}} .l-posts-wrapper .o-post .o-portfolio-item__content, {{WRAPPER}} .l-posts-wrapper .o-post .o-neuron-hover__body, {{WRAPPER}} .l-posts-wrapper .o-neuron-hover--meta-inside .o-neuron-hover-holder .o-neuron-hover-holder__body-meta'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .l-posts-wrapper .o-neuron-hover--meta-inside .o-neuron-hover-holder .o-neuron-hover-holder__body-meta' => 'border-style: {{VALUE}}'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .l-posts-wrapper .o-neuron-hover--meta-inside .o-neuron-hover-holder .o-neuron-hover-holder__body-meta' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .l-posts-wrapper .o-neuron-hover--meta-inside .o-neuron-hover-holder .o-neuron-hover-holder__body-meta' => 'border-color: {{VALUE}}'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .l-posts-wrapper .o-neuron-hover--meta-inside .o-neuron-hover-holder .o-neuron-hover-holder__body-meta' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
	...
	protected function render() {
		...
		if ($query->have_posts()) :
	?>
		<div class="l-posts-wrapper l-filters-holder <?php echo esc_attr('l-posts-wrapper--'. $settings['posts_layout_model'] .'') ?> <?php echo esc_attr($neuron_posts_wrapper_class) ?>" data-posts="<?php echo esc_attr($this->get_ID()) ?>">
