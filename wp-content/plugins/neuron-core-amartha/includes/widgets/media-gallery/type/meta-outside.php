        ...
        <div class="o-neuron-hover__body">
            <div class="o-neuron-hover__body-meta">
                <?php if ($media['query_title']) : ?>
                    <h4 class="o-neuron-hover__body-meta__title">
                        <?php
                        if ($media['query_url']['url'] && $settings['media_gallery_lightbox'] != 'yes') {
                            echo sprintf(
                                '<a href="%s" %s %s>%s</a>',
                ...
                <?php if ($media['query_subtitle']) : ?>
                    <div class="o-neuron-hover__body-meta__subtitle"><?php echo esc_attr($media['query_subtitle']) ?></div>
                <?php endif; ?>
                <?php if ($media['query_description']) : ?>
                    <p class="o-neuron-hover__body-meta__description"><?php echo wp_kses_post($media['query_description']) ?></p>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>       
