        ...
        <div class="elfsight-admin-page-preferences-option-force-script elfsight-admin-page-preferences-option">
            <div class="elfsight-admin-page-preferences-option-info">
                <h4 class="elfsight-admin-page-preferences-option-info-name">
                    <label for="forceScriptAdd"><?php esc_html_e('Add plugin script to every page', $this->textDomain); ?></label>
                </h4>

                <div class="elfsight-admin-caption">
                    <?php esc_html_e('By default the plugin adds its scripts only to pages with its shortcode. This option makes the plugin add scripts to every page. It is useful for ajax websites.', $this->textDomain); ?>
                </div>
            </div>
