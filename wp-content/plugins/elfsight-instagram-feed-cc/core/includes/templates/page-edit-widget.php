...
?><article class="elfsight-admin-page-edit-widget elfsight-admin-page" data-elfsight-admin-page-id="edit-widget">
    ...
    <div class="elfsight-admin-page-edit-widget-form">
        ...
        <div class="elfsight-admin-page-edit-widget-form-actions elfsight-admin-page-edit-widget-form-field">
            <div class="elfsight-admin-page-edit-widget-form-submit elfsight-admin-button-large elfsight-admin-button-green elfsight-admin-button"><?php esc_html_e('Save', $this->textDomain); ?></div>

            <div class="elfsight-admin-page-edit-widget-form-apply elfsight-admin-button-large elfsight-admin-button-white elfsight-admin-button"><?php esc_html_e('Apply', $this->textDomain); ?></div>
        </div>
    </div>
</article>