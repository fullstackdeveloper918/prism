...
class PAFE_Slider_Builder extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'jquery-slick', 'pafe-slider-builder-scripts' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .slick-slider .slick-prev:before, {{WRAPPER}} .elementor-slides-wrapper .slick-slider .slick-next:before' => 'color: {{VALUE}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
	...
	protected function render() {
		...
		?>
            <div class="elementor-slick-slider pafe-slider-builder" data-pafe-slider-builder-slick data-slick='<?php echo json_encode( $slick_options ); ?>'>
            	<?php
