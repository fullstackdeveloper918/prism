...
class PAFE_Responsive_Gallery_Images_Spacing extends \Elementor\Widget_Base {
	...
	protected function init() {
		add_action( 'elementor/element/image-gallery/section_gallery_images/after_section_end', [ $this, 'register_controls' ], 10, 2 );
		add_action( 'elementor/element/pafe-lightbox-gallery/section_gallery_images/after_section_end', [ $this, 'register_controls' ], 10, 2 );
	}
