...
class PAFE_Responsive_Border_Width extends \Elementor\Widget_Base {
	...
	protected function init() {
		add_action( 'elementor/element/section/section_border/before_section_end', [ $this, 'register_controls' ], 10, 2 );
		add_action( 'elementor/element/column/section_border/before_section_end', [ $this, 'register_controls' ], 10, 2 );
		add_action( 'elementor/element/common/_section_border/before_section_end', [ $this, 'register_controls' ], 10, 2 );
	}
