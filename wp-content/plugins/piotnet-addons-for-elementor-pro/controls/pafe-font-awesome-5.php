...
class PAFE_Font_Awesome_5 extends \Elementor\Widget_Base {
	...
	protected function init() {
		add_action( 'elementor/element/icon/section_icon/after_section_end', [ $this, 'register_controls' ], 10, 2 );
		add_action( 'elementor/element/icon-box/section_icon/after_section_end', [ $this, 'register_controls' ], 10, 2 );
