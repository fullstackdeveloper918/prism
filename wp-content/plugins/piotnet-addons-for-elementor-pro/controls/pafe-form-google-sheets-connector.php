...
class PAFE_Form_Google_Sheets_Connector extends \Elementor\Widget_Base {
	...
	protected function init() {
		add_action( 'elementor/element/form/section_form_fields/after_section_end', [ $this, 'register_controls' ], 10, 2 );
		add_action( 'elementor/element/pafe-form-builder-submit/section_conditional_logic/after_section_end', [ $this, 'register_controls' ], 10, 2 );
