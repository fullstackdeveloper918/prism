...
class PAFE_Responsive_Gallery_Column_Width extends \Elementor\Widget_Base {
	...
	protected function init() {
		add_action( 'elementor/element/image-gallery/section_gallery/after_section_end', [ $this, 'register_controls' ], 10, 2 );
		add_action( 'elementor/element/pafe-lightbox-gallery/section_gallery/after_section_end', [ $this, 'register_controls' ], 10, 2 );
	}
