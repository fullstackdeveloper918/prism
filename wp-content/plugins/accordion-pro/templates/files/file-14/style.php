...
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title > a{
    ...
    padding: 14px 21px 14px 45px !important;
	<?php } else { ?>
    padding: 14px 45px 14px 21px !important;
	<?php } ?>
	...
	border-bottom: <?php echo $ac_box_border_size; ?>px solid <?php echo $sel_acc_op_cl_bg_clr; ?> !important;
}
...
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title > a.collapsed{
	border-bottom: <?php echo $ac_box_border_size; ?>px solid <?php echo $acc_title_bg_clr; ?> !important;
    color: <?php echo $acc_title_icon_clr; ?> !important;
	border-bottom: <?php echo $ac_box_border_size; ?>px solid <?php echo $acc_open_cl_icon_bg_clr; ?> !important;
}
...
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title > a:hover{
   color:<?php echo $sel_acc_title_ft_clr; ?> !important;
   border-color:<?php echo $sel_acc_op_cl_bg_clr; ?> !important;
}
...
if($acc_enable_ind_clr=='yes')
{
	...
	{ 	
		...
		#offset_<?php echo $post_id; ?>_<?php echo $k; ?> .wpsm_panel-title > a.collapsed{
			...
			border-color: <?php echo $ind_title_icon_bg_clr;?> !important;
		}
		...
		#offset_<?php echo $post_id; ?>_<?php echo $k; ?> .wpsm_panel-title > a:hover{
		    color:<?php echo $sel_acc_title_ft_clr; ?> !important;
			border-color:<?php echo $sel_acc_title_bg_clr; ?> !important;
		}
		...
		#offset_<?php echo $post_id; ?>_<?php echo $k; ?> .wpsm_panel-title > a.collapsed:hover:before{
			color:<?php echo $sel_acc_op_cl_ft_clr; ?> !important;
			background-color:<?php echo $sel_acc_op_cl_bg_clr; ?> !important;
		}
