...
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title a span:after{
    content: "" !important;
    border-bottom: 25px solid rgba(0, 0, 0, 0) !important;
    border-left: 15px solid <?php echo $sel_acc_op_cl_bg_clr; ?> !important;
...
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title a.collapsed span:after {
	
	border-left-color: <?php echo $acc_open_cl_icon_bg_clr; ?> !important;
}
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title a.collapsed:hover span:after {
	
	border-left-color: <?php echo $sel_acc_op_cl_bg_clr; ?> !important;
}
...
if($acc_enable_ind_clr=='yes')
{
	...
	{ 	
		...
		#offset_<?php echo $post_id; ?>_<?php echo $k; ?> .wpsm_panel-title > a.collapsed span:after{
			border-left-color: <?php echo $ind_open_cl_icon_bg_clr; ?> !important;
		}
