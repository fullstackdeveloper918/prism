		...
		public function plugin_row_meta( $plugin_meta, $plugin_file ) {
			if ( plugin_basename( __FILE__ ) === $plugin_file ) {
				...
				$plugin_meta['view-details'] = sprintf( '<a href="%s" class="thickbox open-plugin-details-modal" aria-label="%s" data-title="%s">%s</a>',
					esc_url( network_admin_url( 'plugin-install.php?tab=plugin-information&plugin=jet-elements&TB_iframe=true&width=600&height=550' ) ),
					esc_attr( __( 'More information about JetElements', 'jet-elements' ) ),
					esc_attr( 'JetElements for Elementor' ),
