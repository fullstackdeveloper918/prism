...
<small>Note: The default options are placed in Customizer > Utility > Breadcrumbs.</small>',
		...
		array(
			'key' => 'field_5c544dbef12dc',
			'label' => 'Body Offset',
			'name' => 'general_body_offset',
			'type' => 'select',
			'instructions' => 'Create a left or right spacing to the content, best use case when creating a lateral header to eleminate the FOUC effect.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
...
<small>Note: The default option is show.</small>',
		...
		array(
			'key' => 'field_5c4348a7af54b',
			'label' => 'Type',
			'name' => 'hero_type',
			'type' => 'select',
			'instructions' => 'Select the type of hero.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5c4348fdaf54c',
			'label' => 'Template',
			'name' => 'hero_template',
			'type' => 'post_object',
			'instructions' => 'Select the template. <br /><small>Note: Do not forget to add heroes in Elementor Templates.</small>',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
						'field' => 'field_5c4348a7af54b',
						'operator' => '==',
						'value' => '3',
					),
				),
...
<small>Note: The default option is center.</small>',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
...
<small>Note: The default option use the post/page feature image.</small>',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
...
<small>Note: The default option in #232931.</small>',
		...
		array(
			'key' => 'field_5b9fc825797eb',
			'label' => 'Subtitle',
			'name' => 'hero_subtitle',
			'type' => 'select',
			'instructions' => 'Select if you want to inherit the subtitle or set it custom.',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
		...
		array(
			'key' => 'field_5b9fc845797ec',
			'label' => 'Custom Subtitle',
			'name' => 'hero_custom_subtitle',
			'type' => 'textarea',
			'instructions' => 'Enter the subtitle, it accepts html tags too.',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
						'field' => 'field_5b9fc825797eb',
						'operator' => '==',
						'value' => '3',
					),
					array(
		...
		array(
			'key' => 'field_5b9fc863797ed',
			'label' => 'Animation',
			'name' => 'hero_subtitle_animation',
			'type' => 'select',
			'instructions' => 'Select initial loading animation for the subtitle. <br />
<small>Note: The default option in Fade In.</small>',
			'required' => 0,
			'conditional_logic' => array(
				array(
		...
		array(
			'key' => 'field_5be08c9aa2cc3',
			'label' => 'Color',
			'name' => 'hero_subtitle_color',
			'type' => 'select',
			'instructions' => 'Select the color of subtitle. <br />
<small>Note: The default option in #858585.</small>',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
		...
		array(
			'key' => 'field_5be08c9ea2cc4',
			'label' => 'Custom Color',
			'name' => 'hero_subtitle_color_custom',
			'type' => 'color_picker',
			'instructions' => 'Select the custom color from the picker.',
			'required' => 0,
			'conditional_logic' => array(
...
<small>Note: The default option is show.</small>',
		...
		array(
			...
			'name' => 'hero_custom_height',
			'type' => 'text',
			'instructions' => 'Enter the height, do not forget to select the unit in the field below.
<br />
<small>Note: Do not forget to add the unit too, for example px/vh/rem/em/%.</small>',
			'required' => 0,
			'conditional_logic' => array(
...
<small>Note: The default option is hide.</small>',
		...
		array(
			...
			'type' => 'select',
			'instructions' => 'Select the title you want to display in the hero. <br />
<small>Note: The default option is use this taxonomy title.</small>',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
