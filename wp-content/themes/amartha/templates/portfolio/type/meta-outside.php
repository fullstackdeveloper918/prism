 ...
 */
$amartha_portfolio_meta_outside_class = 'o-neuron-hover';
$amartha_hover_holder_body_class = ['o-neuron-hover-holder__body', 'justify-content-center', 'd-flex'];
$amartha_hover_holder_body_inner_class = ['o-neuron-hover-holder__body__inner', 'd-flex'];

/**
 * Hover Visibility
 */
if ($neuron_posts_hover_visibility == 'show') {
    $amartha_portfolio_meta_outside_class .= ' o-neuron-hover--icon';
} 
...
if ($neuron_posts_hover_animation == 'translate' && $neuron_posts_hover_visibility != 'hide') {
   $amartha_portfolio_meta_outside_class .= ' o-neuron-hover--translate'; 
} elseif ($neuron_posts_hover_animation == 'scale' && $neuron_posts_hover_visibility != 'hide') {
    $amartha_portfolio_meta_outside_class .= ' o-neuron-hover--scale'; 
}
...
?>
<div class="<?php echo esc_attr($amartha_portfolio_meta_outside_class) ?>">
    ...
    <div class="o-neuron-hover__body o-portfolio-item__content">
        <div class="o-neuron-hover__body-meta">
            <?php if ($neuron_posts_meta_title == 'yes') : ?>
                <h4 class="o-neuron-hover__body-meta__title o-portfolio-item__title"><a href="<?php the_permalink() ?>"><?php the_title() ?></a></h4>
            <?php endif; ?>
