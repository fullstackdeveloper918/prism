 ...
 */
$amartha_portfolio_meta_inside_class = 'o-neuron-hover';
...
if ($neuron_posts_hover_visibility == 'show') {
    $amartha_portfolio_meta_inside_class .= ' o-neuron-hover--meta-inside';
} 
...
if ($neuron_posts_hover_animation == 'translate' && $neuron_posts_hover_visibility != 'hide') {
   $amartha_portfolio_meta_inside_class .= ' o-neuron-hover--translate'; 
} elseif ($neuron_posts_hover_animation == 'scale' && $neuron_posts_hover_visibility != 'hide') {
    $amartha_portfolio_meta_inside_class .= ' o-neuron-hover--scale'; 
}
...
?>
<div class="<?php echo esc_attr($amartha_portfolio_meta_inside_class) ?>">
