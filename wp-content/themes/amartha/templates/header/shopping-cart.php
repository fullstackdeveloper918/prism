 ...
 * Mini Cart
 */
if (!class_exists('WooCommerce') || amartha_inherit_option('shopping_cart_visibility', 'shopping_cart_visibility', '1') == '2') {
    return;
}
global $woocommerce;
 ...
 * Mobile
 */
$amartha_shopping_cart_class = 'l-primary-header__bag';
if (get_theme_mod('shopping_cart_mobile', '2') == '1') {
    $amartha_shopping_cart_class = 'l-primary-header__bag d-flex';
} else {
    $amartha_shopping_cart_class = 'l-primary-header__bag d-none d-lg-flex';
}
?>
<div class="<?php echo esc_attr($amartha_shopping_cart_class) ?>">
