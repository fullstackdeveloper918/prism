...
function getbowtied_customizer_styles(){
	...
	$shopkeeper_theme_options['search_in_titles'] 							= getbowtied_theme_option('search_in_titles', false);
		...
		<style>
			...
			<?php 
				...
				if (!empty($shopkeeper_theme_options['headings_font_size'])): 
					...
					h1, .woocommerce h1, .woocommerce-page h1 { font-size: <?php echo esc_html( $h1_size_mobile ); ?>px; }
					h2, .woocommerce h2, .woocommerce-page h2 { font-size: <?php echo esc_html( $h2_size_mobile ); ?>px; }
					h3, .woocommerce h3, .woocommerce-page h3 { font-size: <?php echo esc_html( $h3_size_mobile ); ?>px; } 
					h4, .woocommerce h4, .woocommerce-page h4 { font-size: <?php echo esc_html( $h4_size_mobile ); ?>px; }
					h5, .woocommerce h5, .woocommerce-page h5 { font-size: <?php echo esc_html( $h5_size_mobile ); ?>px; }
					...
					{
						font-size: <?php echo esc_html( $h0_size_mobile ); ?>px;
					}
					...
					{
						font-size: <?php echo esc_html( $h2_size_mobile ); ?>px;
					}
					...
					{
						font-size: <?php echo esc_html( $h4_size_mobile ); ?>px;
					}
					...
					@media only screen and (max-width: 768px)
					{
						...
						{
							 font-size: <?php echo esc_html( $h1_size_mobile ); ?>px !important;
						}
					}

					@media only screen and (min-width: 768px) {

						h1, .woocommerce h1, .woocommerce-page h1 { font-size: <?php echo esc_html( $h1_size ); ?>px; }
						h2, .woocommerce h2, .woocommerce-page h2 { font-size: <?php echo esc_html( $h2_size ); ?>px; }
						h3, .woocommerce h3, .woocommerce-page h3 { font-size: <?php echo esc_html( $h3_size ); ?>px; } 
						h4, .woocommerce h4, .woocommerce-page h4 { font-size: <?php echo esc_html( $h4_size ); ?>px; }
						h5, .woocommerce h5, .woocommerce-page h5 { font-size: <?php echo esc_html( $h5_size ); ?>px; }
						...
						.woocommerce-account .page-title					
						{
							font-size: <?php echo esc_html( $h0_size ); ?>px;
						}
			...
			<?php 
				...
				if (!empty($shopkeeper_theme_options['body_font_size'])): 
					...
					.fr-caption,
					.woocommerce-order-pay .woocommerce .woocommerce-info
					{ font-size: <?php echo esc_html( $body_base_size ); ?>px !important; }
			<?php 
				...
				if (!empty($shopkeeper_theme_options['product_title_font_size'])): 
					...
					@media only screen and (min-width: 768px) { 
						.woocommerce .product-title-link { 
							font-size: <?php echo esc_html( $product_title_font_size ); ?>px !important; 
						}
					}
			...
			{
				background-color: <?php echo esc_html( $shopkeeper_theme_options['body_color'] ); ?>;	
			}
			...
			{
				fill: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;
			}
			...
			{
				fill: <?php echo esc_html($shopkeeper_theme_options['offcanvas_headings_color']); ?>;
			}
			...
			{
				fill: <?php echo esc_html($shopkeeper_theme_options['top_bar_typography']) ?>;
			}
			<?php endif; ?>
			...
			.transparent_header .with-featured-img
			{
				...
				margin-top: -<?php echo esc_html( $mt ); ?>px;
			}
			...
			{
				fill: <?php echo esc_html($shopkeeper_theme_options['footer_links_color']); ?>;
			}
			<?php endif; ?>
