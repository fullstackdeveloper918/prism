...
document.addEventListener('DOMContentLoaded',function(){$('body.single-product').on('click touchend','.product.product-type-simple .columns > .product_infos .cart .ajax_add_to_cart',function(){var prodTitle=$('.product_title').html()||"";gbt_cln_onAddedToCart($(this),'added',function(){$('.woocommerce-notices-wrapper').empty();$('.woocommerce-notices-wrapper').prepend('<div class="woocommerce-message">'+cartButton+'&quot;'+prodTitle+'&quot;'+addedToCartMessage+'</div>')})})})})(jQuery)