                        ...
                        <div class="site-footer-copyright-area">
                            <div class="row">
								<div class="large-12 columns">
									...
									<?php if ( GETBOWTIED_SHOPKEEPER_EXTENDER_IS_ACTIVE && get_option( 'sk_footer_social_icons', 'no' ) == 'yes' ) : ?>
	                                    <div class="footer_socials_wrapper">
	                                        <?php echo do_shortcode('[social-media items_align="center"]'); ?>
										</div>
                                    <?php endif; ?>
	...
	<div class="cd-quick-view woocommerce"></div>
     ...
     <?php if ( GETBOWTIED_SHOPKEEPER_EXTENDER_IS_ACTIVE && get_option( 'sk_custom_code_footer_js', '' ) != '' ) : ?>
        <?php echo get_option( 'sk_custom_code_footer_js', '' ); ?>
    <?php endif; ?>
