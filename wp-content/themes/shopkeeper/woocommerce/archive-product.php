...
$category_header_src = "";
if ( GETBOWTIED_SHOPKEEPER_EXTENDER_IS_ACTIVE && class_exists('SKCategoryHeaderImage') )  {
	$sk_cat_header = new SKCategoryHeaderImage;
	$category_header_src = $sk_cat_header->woocommerce_get_header_image_url();
}

// Shop Sidebar
$shop_has_sidebar = false;
if ( is_active_sidebar( 'catalog-widget-area' ) && (isset($shopkeeper_theme_options['sidebar_style'])) && ($shopkeeper_theme_options['sidebar_style'] == "0") ) {
