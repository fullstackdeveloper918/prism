...
if ( (isset($shopkeeper_theme_options['catalog_mode'])) && ($shopkeeper_theme_options['catalog_mode'] == 1) ) $sk_product_class .= ' display_buttons';
if ( !$shopkeeper_theme_options['add_to_cart_display']) $sk_product_class .= ' display_buttons';
?>
