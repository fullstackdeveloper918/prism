 ...
 */
require get_template_directory() . '/lib/customizer/customizer-notice/class-customizer-notice.php';

require get_template_directory() . '/lib/customizer/plugin-install/class-plugin-install-helper.php';
